...
atEnv.DEFAULT.atVars.PROJECT_VERSION = { "1", "0", "1" }
...
local atArtifacts =
{
...

  {
    ...
    strModule = 'flash_wfp',
    strArtifact = 'flash_wfp',
    strProject_version = table.concat(atEnv.DEFAULT.atVars.PROJECT_VERSION,'.'),
    archive = {
      structure = {
        ['lua'] = {
          'local/lua/test_class_wfp.lua'
        },
        ['jsx'] = {
          'local/jsx/test_flash_progress.jsx'
        },
        ['parameter'] = {
        ...
        'installer/org.muhkuh.tests-flash_wfp/install.lua',
        'installer/org.muhkuh.tests-flash_wfp/install_testcase.lua'
      },
      extensions = {'tar', 'xz'},
      format = 'tar',
      filter = {'xz'}
    ...
    templates = {
      artifact_configuration = 'installer/org.muhkuh.tests-flash_wfp/flash_wfp.xml',
      pom = 'installer/org.muhkuh.tests-flash_wfp/pom.xml'
    },
